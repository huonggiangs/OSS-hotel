...
- Đã có Value Dashboard MVP, `energy_readings`, `value_ledger` và `operational_alerts`; chưa có đủ baseline/thiết bị thật để gọi là ROI production.
- Đã có rule Alert/SLA tự tạo từ Edge stale và maintenance; notification đa kênh, AI Operations Brain, AI Energy Optimizer và AI Camera vẫn để sau pilot.
