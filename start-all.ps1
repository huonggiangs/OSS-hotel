...
#
# Mo 4 cua so PowerShell rieng, moi cua so chay 1 dich vu (giu nguyen, dung
...
Write-Host ""
Write-Host "Da mo 4 cua so PowerShell — DUNG DONG cac cua so nay khi con dang test." -ForegroundColor Yellow
Write-Host "Lan dau chay se mat khoang 30-90 giay de cai dat + tao du lieu mau." -ForegroundColor Yellow
Write-Host ""
Write-Host "Sau khi ca 4 cua so hien dong 'Ready'/'dang chay', mo trinh duyet:" -ForegroundColor White
